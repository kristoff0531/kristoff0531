...
🔹 **Automation Framework (Cypress)** – End-to-end automation for web applications
🔹 **PDF to Voice** – Convert PDFs into speech using Python
🔹 **Python Slot Game** – Logic-based console game demonstrating probability & randomness
